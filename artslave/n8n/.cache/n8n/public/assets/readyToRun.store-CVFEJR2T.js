(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`n8n@2.25.7`}}catch{}})();try{(function(){var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{},t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`ab7ce123-f5b9-4c79-a353-952e16265403`,e._sentryDebugIdIdentifier=`sentry-dbid-ab7ce123-f5b9-4c79-a353-952e16265403`)})()}catch{}import{Ft as e,Mt as t,Nt as n,S as r,gt as i}from"./vue.runtime.esm-bundler-DvMdhPnl.js";import{s as a}from"./src-DD0gxVae.js";import{gt as o,ht as s}from"./src-CPSIbe-l.js";import{kt as c,t as l}from"./workflows.store-BjtzAPvL.js";import{t as u}from"./useToast-BF8AqXT2.js";import{Bc as d,Qs as f,ru as p,si as m}from"./constants-BpgUKpEP.js";import{T as h}from"./useRootStore-C5w9UjYk.js";import{Rn as g,t as _}from"./settings.store-CSNmqZlM.js";import{_ as v}from"./core-CYpHEtBe.js";import{g as y,p as b,t as x}from"./users.store-DuAADZqU.js";import{t as S}from"./cloudPlan.store-C4_X87Y7.js";import{t as C}from"./folders.store-HFzL4JyZ.js";var w={name:`AI Agent workflow`,meta:{templateId:`ready-to-run-ai-workflow`},nodes:[{parameters:{url:`https://www.theverge.com/rss/index.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[128,448],id:`a26f16ce-82a5-4392-a032-622467e0098f`,name:`Get Tech News`},{parameters:{toolDescription:`Reads the news`,url:`=https://feeds.bbci.co.uk/news/world/rss.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[272,448],id:`91d1a929-b913-4399-977a-4306fe8349c7`,name:`Get World News`},{parameters:{model:{__rl:!0,mode:`list`,value:`gpt-4.1-mini`},options:{}},type:`@n8n/n8n-nodes-langchain.lmChatOpenAi`,typeVersion:1.2,position:[-144,448],id:`482c5e90-74ea-424c-9ec3-1dc14dd460f9`,name:`OpenAI Model`,notesInFlow:!0,credentials:{},notes:`Free n8n credits `},{parameters:{promptType:`define`,text:`=Provide a summary of world and tech news from the last 24 hours. 
...
Today is {{ $today }}
`}},type:`@n8n/n8n-nodes-langchain.agent`,typeVersion:3,position:[192,64],id:`ce5dd204-b9d3-4455-ab0c-0c2ce314ad52`,name:`AI Agent`}],pinData:{},connections:{"When chat message received":{main:[[{node:`AI Agent`,type:`main`,index:0}]]},"OpenAI Model":{ai_languageModel:[[{node:`AI Agent`,type:`ai_languageModel`,index:0}]]},"Simple Memory":{ai_memory:[[{node:`AI Agent`,type:`ai_memory`,index:0}]]},Hackernews:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},TheVerge:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"BBC News":{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"Google Sheets":{ai_tool:[[]]}}},k=h(g.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2,()=>{let e=y(),t=S(),n=r(()=>e.getVariant(p.name)),i=r(()=>n.value===p.variant5),a=r(()=>n.value===p.variant6),o=r(()=>t.userIsTrialing&&(i.value||a.value));return{currentVariant:n,getWorkflowForVariant:()=>{if(o.value){if(i.value)return D;if(a.value)return O}},isFeatureEnabled:o}}),A=`N8N_READY_TO_RUN_OPENAI_CREDENTIAL_ID`,j=h(g.READY_TO_RUN,()=>{let n=[`ready-to-run-ai-workflow`,`ready-to-run-ai-workflow-v5`,`ready-to-run-ai-workflow-v6`],s=b(),p=a(),h=u(),g=o(),y=c(),S=x(),C=_(),T=l(),D=k(),O=v(A,``),j=e(!1),M=r(()=>!!y.allCredentials.filter(e=>e.type===d).length),N=r(()=>!!S.currentUser?.settings?.userClaimedAiCredits),P=336*60*60*1e3,F=e(Date.now()),I,L=()=>{I!==void 0&&(clearTimeout(I),I=void 0)},R=()=>{let e=S.currentUser?.createdAt;if(!e)return;let t=new Date(e).getTime();return Number.isFinite(t)?t:void 0},z=()=>{L();let e=R();if(e===void 0)return;let t=e+P-Date.now();t<=0||(I=setTimeout(()=>{F.value=Date.now(),I=void 0},t))};i(()=>S.currentUser?.createdAt,()=>{F.value=Date.now(),z()},{immediate:!0}),t(()=>{L()});let B=()=>{let e=R();return e===void 0?!1:F.value-e<P},V=r(()=>C.isAiCreditsEnabled&&!M.value&&!N.value),H=e=>{s.track(`User executed ready to run AI workflow`,{status:e})},U=()=>{s.track(`User executed ready to run AI workflow successfully`)},W=async e=>{j.value=!0;try{let t=await y.claimFreeAiCredits(e);return O.value=t.id,s.track(`User claimed OpenAI credits`),t}catch(e){throw h.showError(e,p.baseText(`freeAi.credits.showError.claim.title`),{message:p.baseText(`freeAi.credits.showError.claim.message`)}),e}finally{j.value=!1}},G=()=>D.getWorkflowForVariant()??w,K=async(e,t)=>{s.track(`User opened ready to run AI workflow`,{source:e});try{let e={...G(),parentFolderId:t},n=O.value;if(n&&e.nodes){let t=f(e),r=t.nodes?.find(e=>e.name===`OpenAI Model`);r&&(r.credentials??={},r.credentials[d]={id:n,name:``}),e=t}let r=await T.createNewWorkflow(e);return await g.push({name:m.WORKFLOW,params:{workflowId:r.id}}),r}catch(e){throw h.showError(e,p.baseText(`generic.error`)),e}},q=async(e,t,n)=>{await W(n),await K(e,t),S?.currentUser?.settings&&(S.currentUser.settings.userClaimedAiCredits=!0)},J=(e,t)=>V.value&&!t&&e,Y=(e,t,n)=>V.value&&!n&&t&&e&&B(),{isTrulyEmpty:X}=E();return{claimingCredits:j,userCanClaimOpenAiCredits:V,claimFreeAiCredits:W,createAndOpenAiWorkflow:K,claimCreditsAndOpenWorkflow:q,getCardVisibility:J,getButtonVisibility:Y,getSimplifiedLayoutVisibility:e=>X(e),trackExecuteAiWorkflow:H,trackExecuteAiWorkflowSuccess:U,isReadyToRunTemplateId:e=>!!e&&n.includes(e)}});export{w as a,T as i,D as n,E as r,j as t};
//# sourceMappingURL=readyToRun.store-CVFEJR2T.js.map